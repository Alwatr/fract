...
import {rtlDirectionPlugin} from './lib/rtl-direction.js';
...
export const tailwindConfig: Omit<Config, 'content'> = {
  ...
  plugins: [colorPlugin, elevationPlugin, stateLayerPlugin, translucentPlugin, safeAreaPlugin, rtlDirectionPlugin],
};
